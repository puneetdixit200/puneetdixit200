...
- [clash-verge-rev/clash-verge-rev #7215](https://github.com/clash-verge-rev/clash-verge-rev/pull/7215) - fix: restore default size for collapsed window state. _(129.6k stars)_
- [tauri-apps/tauri #15427](https://github.com/tauri-apps/tauri/pull/15427) - fix(cli): respect src/bin required-features (fix: #15325). _(108.7k stars)_
...
- [langgenius/dify #37059](https://github.com/langgenius/dify/pull/37059) - fix(weaviate): return BM25 score metadata. _(147.7k stars)_
...
- [ansible/ansible #87063](https://github.com/ansible/ansible/pull/87063) - Fix ansible_connection mutation between loop items. _(69.3k stars)_
- [lodash/lodash #6229](https://github.com/lodash/lodash/pull/6229) - Fix cloneDeep Map key cloning. _(61.2k stars)_
- [starship/starship #7493](https://github.com/starship/starship/pull/7493) - fix(bash): clear status after empty command. _(58.7k stars)_
...
- 2nd Place, Business Plan - RVITM Wadhwani Ignite Bootcamp.
